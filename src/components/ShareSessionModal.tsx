...
const ShareSessionModal: React.FC<ShareSessionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm bg-black bg-opacity-50 animate-fadeIn">
      <div className="bg-[#0D1117] rounded-xl shadow-2xl w-full max-w-md p-6 animate-slideUp border border-gray-800">
        {/* Header */}
        ...
        <div className="space-y-4">
          {!accessCode ? (
            <div className="text-center py-4">
              <p className="text-gray-400 mb-4">Generate a link to invite others to your session</p>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1E293B] p-4 rounded-lg border border-gray-700">
                ...
                <div className="flex  items-center">
                  <input
                    ...
                    value={link}
                    readOnly
                    className="flex-1 border border-gray-700 bg-[#0B0F14] text-white rounded-l px-3 py-2 text-sm truncate focus:ring-1 focus:ring-blue-500 outline-none"
                  />
                  <button
                    onClick={handleCopyLink}
                    className={`bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-r font-medium text-sm transition-transform transform hover:scale-105 hover:from-blue-600 hover:to-cyan-600`}
                  >
                    {copied ? 'Copied!' : 'Copy'}
                  </button>
                </div>
              ...
              {/* Instructions */}
              <div className="bg-blue-900/20 border border-blue-800/50 rounded-lg p-4 text-sm text-blue-300 space-y-1">
              ...
              <div className="flex justify-end pt-2">
                <button
                  onClick={onClose}
                  className="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-600 font-medium transition-transform transform hover:scale-105"
                >
                  Close
                </button>
              </div>
